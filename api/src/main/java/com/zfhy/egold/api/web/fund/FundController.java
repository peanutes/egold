...
public class FundController {
    ...
    @PostMapping("/currentGoldAvgPrice")
    public Result<CurrentGoldAvgPrice> currentGoldAvgPrice(@ModelAttribute @Valid SysParameter sysParameter) {

        MemberSession member = this.redisService.checkAndGetMemberToken(sysParameter.getToken());

        CurrentGoldAvgPrice goldAvgPrice = this.investRecordService.getCurrentGoldAvgPrice(member.getId());

        return ResultGenerator.genSuccessResult(goldAvgPrice);
    }
