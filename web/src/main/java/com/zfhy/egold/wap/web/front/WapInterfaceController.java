...
@Slf4j
@Validated
public class WapInterfaceController {
    ...
    public String newsDetail( @ApiParam(name = "id", value = "资讯id") @NotNull @RequestParam Integer id, Model model) {
        Condition condition = new Condition(HotInfo.class);
        condition.createCriteria()
                .andEqualTo("delFlag", "0")
                .andEqualTo("status", 1)
    ...
    public String productIntroduction( Model model) {
    ...
    public String newUserInterst( Model model) {
    ...
    public String newUserSpecialPriceGold( Model model) {
        FinancialProduct newUserProduct = this.financialProductService.findNewUserProduct();
    ...
    public String newUserBuyGoldTicket( Model model) {
    ...
    public String millionGoldInterest( Model model) {
