package com.zfhy.egold.wap.web.order;
...
public class OrderController {
    ...
    public Result<String> validatePaySmsCode4Mall(
            ...
            @NotNull @RequestParam String smsCode,
            @ModelAttribute @Valid SysParameter sysParameter,
            @ApiParam(name = "token", value = "商城使用这token来验证登录", required = true)
            @NotNull @RequestParam String token4Mall) {

        MemberSession member = this.redisService.checkAndGetMemberToken4Mall(token4Mall);
