$(function () {
	...
	$("#toGoldOrder").click(function () {
		...
		goToPage("/goldMall/toGoldOrder?skuId=" + skuId);
	});
	...
	$("#goToChooseAddress").click(function () {
		window.location = "/myAddress/list";
	});
	...
	function showPayPasswordForm() {
		...
		$("#payOrder").click(function () {
				...
				$.post(getApiUrl("/mall/submitInvoice"), {
	...
	function payForTheOrder() {
		...
		$.post(getApiUrl("/mall/submitOrder"), {
			skuId: skuId,
			num: num,
